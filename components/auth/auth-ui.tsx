...
export function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
      dangerouslySetInnerHTML={{ __html: GOOGLE_LOGO_INNER_SVG }}
    />
  );
}
