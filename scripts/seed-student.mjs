/**
 * Creates the student@shikshaloy.com demo account via Supabase Admin REST API.
 * Run: node scripts/seed-student.mjs
 */
...
const EMAIL = "student@shikshaloy.com";
