/**
 * Creates the driver@shikshaloy.com demo account via Supabase Admin REST API.
 * Run: node scripts/seed-driver.mjs
 */
...
const EMAIL = "driver@shikshaloy.com";
const PASSWORD = "Driver@123";

async function main() {
  console.log("\n🌱  Seeding driver account…");
