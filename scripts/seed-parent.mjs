/**
 * Creates the parent@shikshaloy.com demo account via Supabase Admin REST API.
 * Run: node scripts/seed-parent.mjs
 */
...
const EMAIL = "parent@shikshaloy.com";
const PASSWORD = "Parent@123";

async function main() {
  console.log("\n🌱  Seeding parent account…");
