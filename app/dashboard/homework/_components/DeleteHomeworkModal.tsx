    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" onClick={onClose}>
      <div onClick={(e) => e.stopPropagation()} className="w-full max-w-sm rounded-2xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-2xl">
        <div className="p-5 space-y-2">
          <p className="text-sm font-semibold text-gray-900 dark:text-zinc-50">Delete assignment?</p>
          <p className="text-sm text-gray-500 dark:text-zinc-400">
            This will permanently remove <span className="font-medium text-gray-700 dark:text-zinc-300">&ldquo;{homework.title}&rdquo;</span> and all student submissions for it. This can&apos;t be undone.
          </p>
