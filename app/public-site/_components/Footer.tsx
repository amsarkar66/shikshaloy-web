...
export function Footer({ schools, settings }: { schools: PublicSchool[]; settings?: SiteSettings }) {
  ...
  const tagline = settings?.footer.tagline || school.tagline;
  const showQuickLinks = settings?.footer.showQuickLinks ?? true;

  return (
    <footer className="border-t border-gray-200 bg-gray-900 text-gray-300">
      <div className="mx-auto max-w-5xl px-6 py-12">
        <div className={`grid grid-cols-1 gap-10 ${showQuickLinks ? "sm:grid-cols-2" : ""}`}>
          <div>
